...
<head>
    ...
    <link href="{{asset('/')}}public/front/css/modern-business.css" rel="stylesheet">
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="{{route('/')}}">Shamim Hossain</a>
...
<footer class="py-3 bg-dark">
    <div class="container">
        <p class="m-0 text-center text-white">Copyright 2018 &copy;  Shamim Hossain</p>
    </div>
    <!-- /.container -->
</footer>
